...
class SATreeCraft:
    ...
    def __init__(self,
                 ...
                 true_labels_for_points: Optional[Union[List, np.ndarray]] = None,
                 features_numerical: Optional[Union[List[str], np.ndarray]] = None,
                 features_categorical: Optional[Union[List[str], np.ndarray]] = None,
